...
export async function getOptionalUser(request: Request | NextRequest): Promise<AuthContext | null> {
  return getSupabaseFromRequest(request);
}

export async function requireUser(request: Request | NextRequest): Promise<AuthContext> {
