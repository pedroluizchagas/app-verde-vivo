...
export function WorkOrderEditForm({
  ...
  const materialsBaseTotal = useMemo(
    () => items.reduce((sum, it) => sum + Number(it.unit_cost) * Number(it.quantity), 0),
    [items],
  );
  ...
  const total = useMemo(
    () => Number(laborCost) + materialsPriceTotal - Number(discount),
    [laborCost, materialsPriceTotal, discount],
  );
        ...
        <CardContent className="grid gap-3 p-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      min="1"
                      value={areasCount}
                      onChange={(e) => setAreasCount(Number(e.target.value))}
                    />
                  </div>
                  <div className="space-y-1">
                    <Label>Perda (%)</Label>
              ...
              <div className="grid gap-2">
                {items.map((it, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="grid grid-cols-1 sm:grid-cols-5 items-center gap-3 rounded-md border p-3"
                    >
                      <div className="sm:col-span-2">
                        ...
                        <div className="mt-2 grid grid-cols-2 gap-2">
                          ...
                          <div>
                            ...
                            <Select
                              value={it.unit || "un"}
                              onValueChange={(v) => updateItemUnit(idx, v)}
                            >
          ...
          <div className="flex gap-2">
            ...
            <Button type="submit" className="flex-1" disabled={isLoading}>
              {isLoading ? "Salvando..." : "Atualizar OS"}
            </Button>
          </div>
        </CardContent>
      </Card>
