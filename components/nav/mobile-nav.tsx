    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t bg-card">
      ...
      {(open || closing) && (
        <div className="fixed inset-0 z-[60]" aria-modal="true" role="dialog">
          ...
          <div
            className={cn(
              "absolute bottom-16 left-0 right-0 mx-4 rounded-lg border bg-card shadow-lg",
              closing
              ...
              {open === "operacao" && (
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <SheetLink
                    ...
                    active={isActive("/dashboard/work-orders")}
                  />
                  <SheetLink
                    ...
                    active={isActive("/dashboard/budgets")}
                  />
                  <SheetLink
              ...
              {open === "negocios" && (
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <SheetLink
                    ...
                    active={isActive("/dashboard/maintenance")}
                  />
                  <SheetLink
              ...
              {open === "config" && (
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <SheetLink
                    ...
                    active={isActive("/dashboard/finance/categories")}
                  />
                  <SheetLink
