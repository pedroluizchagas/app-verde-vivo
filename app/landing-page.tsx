...
function DashboardMockup() {
  ...
  const T = mockLightMode
    ? {
        ...
        subtle: "rgba(0,0,0,0.26)",
        green: "#16a34a",
        greenDim: "#15803d",
        greenGlow: "rgba(22,163,74,0.08)",
        greenGlow2: "rgba(22,163,74,0.04)",
      }
    : {
        bg: "#0c0c0c",
        bg2: "#111111",
  ...
  const mockNotifications = [
    {
      ...
      desc: "Juliana Santos aprovou o orçamento #127",
      time: "Há 12 min",
      unread: true,
    },
    {
      ...
      desc: "Poda de arbustos — Seg, 23 Mar às 08:00",
      time: "Há 34 min",
      unread: true,
    },
    {
      ...
      desc: "R$ 850,00 de Marco Rodrigues",
      time: "Há 1h",
      unread: true,
    },
    {
      ...
      desc: "Manutenção jardim — Pedro Lima",
      time: "Há 2h",
      unread: false,
    },
    {
      ...
      desc: "Fernanda Oliveira foi adicionada",
      time: "Há 3h",
      unread: false,
    },
    {
      ...
      desc: "Plano mensal de André Costa vence em 3 dias",
      time: "Há 5h",
      unread: false,
    },
  ];
    ...
    switch (activeView) {
          ...
          <>
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                >
                  {mockLightMode ? (
                    <Moon size={11} style={{ color: T.muted }} />
                  ) : (
                    <Sun size={11} style={{ color: T.muted }} />
                  )}
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: 7.5, color: T.muted, lineHeight: 1, textAlign: "left" }}
                    >
                      pedro@email.com
                    </div>
                  </div>
                ...
                >
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 7.5, color: T.muted, marginTop: 3 }}>
                        do mês atual
                      </div>
                    </div>
                    {/* Serviços Pendentes */}
                    ...
                    {appointments.map((a, i) => (
                      <div
                        ...
                        style={{
                          ...
                          padding: "5px 4px",
                          borderBottom:
                            i < appointments.length - 1 ? `1px solid ${ca(0.04)}` : "none",
                        }}
                      >
                        {/* Checkbox */}
                        {a.done ? (
        ...
        return (
          <>
            ...
            >
              ...
              <span style={{ fontSize: 9.5, color: T.subtle }}>
                Buscar por nome, telefone ou endereço...
              </span>
            </div>
              ...
              {clientGroups.map((group) => (
                <div key={group.letter}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 8 }}>
                    ...
                    <span style={{ fontSize: 7.5, color: T.muted, flexShrink: 0 }}>
      ...
      case "Agenda": {
        ...
        > = {
          scheduled: {
            ...
            text: mockLightMode ? "#2563eb" : "#60a5fa",
            border: "#3b82f6",
            dot: "#3b82f6",
          },
          in_progress: {
            bg: "rgba(245,158,11,0.10)",
            text: mockLightMode ? "#d97706" : "#fbbf24",
            border: "#f59e0b",
            dot: "#f59e0b",
          },
          completed: {
            bg: "rgba(16,185,129,0.10)",
            text: mockLightMode ? "#059669" : "#34d399",
            border: "#10b981",
            dot: "#10b981",
          },
        };
        ...
        const typeLabelsAg: Record<string, string> = {
          service: "Serviço",
        ...
        const marchDays = 31;
        const calCells: (number | null)[] = [
          ...Array(marchStart).fill(null),
          ...Array.from({ length: marchDays }, (_, i) => i + 1),
        ];
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: 9, fontWeight: 600, color: T.text }}>
                      Serviços de hoje
                    </span>
                    <span
                      style={{
      ...
      case "Ordens de Serviço": {
        ...
        const osStatusStyles: Record<string, { bg: string; text: string; border: string }> = {
          ...
          cancelled: {
            ...
            text: mockLightMode ? "#dc2626" : "#f87171",
            border: "#ef4444",
          },
        };
            ...
            >
              {[
                ...
                >
                  ...
                  <div
                    style={{
                      fontSize: k.label === "Receita" ? 13 : 16,
                      fontWeight: 800,
                      letterSpacing: "-0.4px",
                      color: T.text,
                    }}
        ...
        return (
          <>
            ...
            {[
              ...
              {
                title: "Manutenção mensal condomínio",
                client: "Cond. Jardins",
                status: "Pendente",
                statusColor: "amber",
                amount: "R$ 2.800",
      ...
      case "Notas":
        return (
          <>
            ...
            {[
              {
                title: "Cuidados com orquídeas",
                preview: "Regar 2x por semana, luz indireta...",
                importance: "high",
                tag: "Plantas",
              },
              {
                title: "Fornecedor de mudas",
                preview: "Contato: Flora Garden - (11) 3456...",
                importance: "medium",
                tag: "Fornecedores",
              },
              {
                title: "Receita de adubo orgânico",
                preview: "Misturar húmus com casca de ovo...",
                importance: "low",
                tag: "Técnicas",
              },
              {
                title: "Pragas em roseiras",
                preview: "Aplicar neem a cada 15 dias...",
                importance: "high",
                tag: "Pragas",
              },
            ].map((n, i) => (
        ...
        return (
          <>
            ...
            {[
              ...
              {
                title: "Orçar sistema de irrigação",
                done: false,
                due: "Amanhã",
                priority: "medium",
              },
              ...
              <ListRow key={i}>
                ...
                >
                  {t.done && (
                    <span style={{ fontSize: 9, color: onGreen, fontWeight: 800 }}>✓</span>
                  )}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div
                ...
                <div
                  style={{
                    fontSize: 9,
                    color: t.due === "Hoje" ? "#f87171" : T.muted,
                    flexShrink: 0,
                  }}
                >
                  {t.due}
        ...
        return (
          <>
            ...
            >
              ...
              >
                <div style={{ fontSize: 9, fontWeight: 600, color: T.text, marginBottom: 6 }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        flexShrink: 0,
                        background:
                          p.type === "income" ? "rgba(16,185,129,0.10)" : "rgba(239,68,68,0.10)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                      }}
                    ...
                    <div style={{ textAlign: "right", flexShrink: 0 }}>
                      <div
                        style={{
                          fontSize: 8,
                          fontWeight: 600,
                          color: p.type === "income" ? incomeColor : expenseColor,
                          fontVariantNumeric: "tabular-nums",
                        }}
                      >
                    ...
                    >
                      <span
                        style={{
                          ...
                          flexShrink: 0,
                          background:
                            al.type === "income" ? "rgba(16,185,129,0.10)" : "rgba(239,68,68,0.10)",
                          color: al.type === "income" ? incomeColor : expenseColor,
                        }}
                      >
                        {al.type === "income" ? "Receita" : "Despesa"}
                      </span>
                      <span
                        style={{
                          fontSize: 8,
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      flexShrink: 0,
                      background:
                        t.type === "income" ? "rgba(16,185,129,0.10)" : "rgba(239,68,68,0.10)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                    }}
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          borderRadius: 8,
                          background:
                            t.status === "paid" ? "rgba(16,185,129,0.10)" : "rgba(245,158,11,0.10)",
      ...
      case "Estoque": {
        ...
        const movements = [
          ...
          {
            product: "Semente grama esmeralda",
            qty: "2 kg",
            type: "out",
            desc: "Plantio jardim Marco",
            date: "21/03",
            cost: null,
          },
          {
            product: "Substrato vegetal",
            qty: "40 L",
            type: "in",
            desc: "Reposição",
            date: "20/03",
          ...
          {
            product: "Defensivo Neem",
            qty: "1 L",
            type: "out",
            desc: "Aplicação Pedro Lima",
            date: "19/03",
            cost: null,
          },
        ];
        ...
        return (
          <>
            ...
            {/* Título da seção */}
            <div style={{ fontSize: 10, fontWeight: 600, color: T.text, marginBottom: 8 }}>
            ...
            >
              ...
              >
                <div style={{ fontSize: 9, fontWeight: 600, color: T.text, marginBottom: 8 }}>
                  Última compra
                </div>
                <div style={{ fontSize: 9, fontWeight: 500, color: T.text, marginBottom: 2 }}>
                  Adubo NPK 10-10-10
                </div>
                <div style={{ fontSize: 7, color: T.muted, marginBottom: 4 }}>
                  10 kg — Unit: R$ 3,50
                </div>
                <div style={{ fontSize: 10, fontWeight: 700, color: T.text, marginBottom: 2 }}>
                  R$ 35,00
                </div>
              ...
              {movements.map((m, i) => (
                ...
                >
                  {m.type === "in" ? (
                    <ArrowUpCircle
                      size={11}
                      style={{ color: mockLightMode ? "#059669" : "#10b981", flexShrink: 0 }}
                    />
                  ) : (
                    <ArrowDownCircle size={11} style={{ color: redStock, flexShrink: 0 }} />
                  )}
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 9, fontWeight: 500, color: T.text }}>
                      {m.product} ({m.qty})
                    </div>
      ...
      case "Manutenções": {
        ...
        const mtStatusLabels: Record<string, string> = {
          active: "Ativo",
          paused: "Pausado",
          cancelled: "Cancelado",
        };
        ...
        const plans = [
          {
            title: "Manutenção mensal - Jardim frontal",
            client: "Marco Rodrigues",
            status: "active",
            sun: "Sol pleno",
            water: "3x/sem",
          ...
          {
            title: "Manutenção mensal - Área externa",
            client: "Juliana Santos",
            status: "active",
            sun: "Meia sombra",
            water: "2x/sem",
          ...
          {
            title: "Manutenção mensal - Jardim condomínio",
            client: "Cond. Jardins",
            status: "active",
            sun: null,
            water: "4x/sem",
          ...
          {
            title: "Manutenção mensal - Quintal",
            client: "Pedro Lima",
            status: "paused",
            sun: "Sol pleno",
            water: "2x/sem",
            lastDate: "28 fev 2026",
            overdue: false,
          },
          {
            title: "Manutenção mensal - Varanda e jardineiras",
            client: "André Costa",
            status: "active",
            sun: "Meia sombra",
            water: "3x/sem",
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 5 }}>
                      ...
                      <div
                        style={{
                          ...
                          fontSize: 7,
                          fontWeight: 500,
                          color: mockLightMode ? "#2563eb" : "#60a5fa",
                        }}
                      >
                        <Droplets size={7} />
                        Rega {m.water}
                      ...
                      {m.overdue ? (
                        <>
                          ...
                          <span style={{ fontSize: 7.5, fontWeight: 500, color: amberMt }}>
                            {m.overdueDays
                              ? `Sem manutenção há ${m.overdueDays} dias`
                              : "Nunca executado"}
                          </span>
                        </>
                      ) : m.lastDate ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
            ...
            <div
              style={{
                ...
                gap: 8,
                padding: "12px 14px",
                borderBottom: `1px solid ${ca(0.06)}`,
              }}
            >
              <div
                style={{
            ...
            >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 4, paddingLeft: 26 }}>
                {["Agendar serviço", "Criar orçamento", "Novo cliente", "Registrar despesa"].map(
                  (s) => (
                    <div
                      key={s}
                      style={{
              ...
              <div style={{ display: "flex", gap: 6, alignItems: "flex-end", maxWidth: "85%" }}>
                ...
                >
                  Poda agendada para Marco Rodrigues amanhã (23/03) às 09:00. Deseja adicionar
                  alguma observação?
                </div>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 10 }}>
                  ...
                  <span style={{ fontSize: 9.5, fontWeight: 600, color: T.text }}>
                    Foto de perfil
                  </span>
                </div>
                <div
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
                  <div>
                    <div
                      style={{ fontSize: 7.5, fontWeight: 500, color: T.muted, marginBottom: 3 }}
                    >
                      Nome da empresa
                    </div>
                    <div
                  ...
                  <div>
                    <div
                      style={{ fontSize: 7.5, fontWeight: 500, color: T.muted, marginBottom: 3 }}
                    >
                      Subtítulo <span style={{ color: ca(0.3) }}>(opcional)</span>
                    </div>
                    <div
                      style={{
                        background: ca(0.03),
              ...
              >
                ...
                >
                  <div style={{ fontSize: 9.5, fontWeight: 600, color: T.text, marginBottom: 3 }}>
                    Plano Plus
                  </div>
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 8, color: ca(0.35), lineHeight: 1, textAlign: "left" }}>
...
function Hero() {
  return (
    <section
      style={{
        padding: "clamp(100px, 15vw, 140px) 0 0",
        minHeight: "120vh",
        textAlign: "center",
        position: "relative",
      }}
    >
      ...
      >
        ...
        <div style={{ animation: "fadeUp 0.6s 0.16s cubic-bezier(0.16,1,0.3,1) both" }}>
          ...
          >
            Organize clientes, agenda, finanças e ordens de serviço em um único lugar. Economize
            horas todo dia e foque no que realmente importa.
          </p>
        </div>
  ...
  return (
    ...
    >
      ...
      <span style={{ color: T.muted, fontWeight: 600 }}>
        +500 jardineiros e paisagistas brasileiros
      </span>
    </div>
  );
}
...
function About() {
  const aboutFeatures = [
    {
      icon: <Leaf size={15} />,
      title: "Feito para Jardinagem",
      desc: "Pensado para o dia a dia real do profissional do verde.",
    },
    {
      icon: <Smartphone size={15} />,
      title: "Web + App Mobile",
      desc: "Acesse do computador ou do celular, onde você estiver.",
    },
    {
      icon: <Bot size={15} />,
      title: "Íris — Assistente IA",
      desc: "Crie clientes, agendas e orçamentos por voz ou texto.",
    },
    {
      icon: <Lock size={15} />,
      title: "Dados Protegidos",
      desc: "Criptografia de nível bancário com Supabase + RLS.",
    },
  ];
              ...
              >
                ...
                <div
                  style={{
                    position: "absolute",
                    background:
                      "radial-gradient(ellipse at 35% 45%, rgba(26,255,94,0.1) 0%, transparent 65%)",
                    inset: 0,
                  }}
                />
                ...
                >
                    ...
                    {[100, 70, 85, 60, 92, 55, 78].map((w, i) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 3,
                          background:
                            i % 3 === 0 ? "rgba(26,255,94,0.35)" : "rgba(255,255,255,0.07)",
                        }}
                      />
                    ))}
                  </div>
                  <div>
                    ...
                    <div
                      style={{ fontSize: 11.5, color: T.muted, lineHeight: 1.55, maxWidth: 160 }}
                    >
                      iOS e Android. Grave áudios para a Íris enquanto trabalha no jardim.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div>
            <Reveal>
              ...
              <p style={{ fontSize: 16.5, color: T.muted, lineHeight: 1.74, marginBottom: 36 }}>
                O GestãoGarden nasceu para profissionalizar o mercado de jardinagem e paisagismo no
                Brasil. Tudo que você precisa em um único sistema, sem burocracia.
              </p>
            </Reveal>
...
function ClientsMockup() {
  ...
  return (
    <div
      style={{
        background: "linear-gradient(135deg, #0d1e0f, #121a12)",
        padding: 16,
        height: "100%",
        display: "flex",
        flexDirection: "column",
        ...
        >
          ...
          <div
            style={{
              ...
              color: T.green,
              border: "1px solid rgba(26,255,94,0.2)",
              fontWeight: 600,
            }}
          >
            {badge}
        ...
        {days.map((d) => (
          <div
            ...
            style={{
              ...
              fontSize: 10,
              borderRadius: 5,
              fontWeight: d === 20 ? 800 : 500,
              background:
                d === 20 ? T.green : events.includes(d) ? "rgba(26,255,94,0.14)" : "transparent",
...
function AIMockup() {
  return (
    <div
      style={{
        background: "linear-gradient(135deg, #0a180b, #0d1a0e)",
        padding: 16,
        height: "100%",
        display: "flex",
        flexDirection: "column",
    ...
    <Reveal delay={delay}>
      ...
      >
        ...
        <div style={{ padding: "22px 24px 26px" }}>
          <h3 style={{ fontSize: 17, fontWeight: 800, letterSpacing: "-0.3px", marginBottom: 8 }}>
            {title}
          </h3>
      ...
      {[
        {
          ...
          status: "Em andamento",
          statusColor: T.green,
          bg: "rgba(26,255,94,0.08)",
          border: "rgba(26,255,94,0.2)",
        },
        {
          num: "#123",
          title: "Paisagismo Jardim",
          client: "Ana Castro",
          value: "R$ 1.200",
          status: "Concluído",
          statusColor: "#6dcca0",
          bg: "rgba(100,200,150,0.06)",
        ...
        >
          ...
          <div style={{ fontSize: 10.5, color: T.subtle }}>
            {client} · {value}
          </div>
        </div>
      ))}
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          <FeatureCard
            ...
            desc="Cadastre todos os seus clientes com histórico completo, preferências, endereços e contatos. Acesso rápido a qualquer informação."
            delay={0}
          >
            <ClientsMockup />
          </FeatureCard>
          <FeatureCard
            ...
            desc="Visualize todos os seus agendamentos com clareza. Nunca mais perca um compromisso ou confunda horários de serviço."
            delay={0.08}
          >
            <CalendarMockup />
          </FeatureCard>
        ...
        >
          <FeatureCard
            ...
            desc="Registre receitas e despesas, acompanhe seu resultado e entenda para onde vai seu dinheiro com relatórios visuais."
            delay={0}
          >
            <FinanceMockup />
          </FeatureCard>
          <FeatureCard
            title="Assistente de IA Íris"
            desc="Fale com a Íris por texto ou voz para criar clientes, agendamentos e orçamentos instantaneamente. Trabalhe sem parar."
            delay={0.08}
          >
            <AIMockup />
          </FeatureCard>
    ...
    <section style={{ padding: "72px 0", overflow: "hidden" }}>
      ...
      >
        <Reveal>
          ...
          <p style={{ fontSize: 15.5, color: T.muted }}>
            Pagamentos, comunicação e muito mais integrados nativamente.
          </p>
        </Reveal>
      </div>
...
const testimonials = [
  {
    ...
    name: "Marco Rodrigues",
    role: "Jardinagem Rodrigues, Belo Horizonte",
    init: "MR",
  },
  {
    ...
    name: "Juliana Santos",
    role: "Verde Vida Paisagismo, São Paulo",
    init: "JS",
  },
  {
    ...
    name: "André Costa",
    role: "Jardineiro Autônomo, Curitiba",
    init: "AC",
  },
  {
  ...
  },
  {
    ...
    role: "Ferreira Jardins, Porto Alegre",
    init: "RF",
  },
  {
    ...
    name: "Cláudia Mendes",
    role: "Mendes Paisagismo, Brasília",
    init: "CM",
  },
];
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          ...
          <Reveal delay={0}>
            ...
            >
              <div
                style={{ fontSize: 18, fontWeight: 800, letterSpacing: "-0.3px", marginBottom: 8 }}
              >
                Trial Gratuito
              </div>
              <div style={{ fontSize: 13, color: T.muted, lineHeight: 1.6, marginBottom: 22 }}>
                Para conhecer o GestãoGarden sem compromisso.
              </div>
              <div
                style={{ fontSize: 38, fontWeight: 800, letterSpacing: "-1.5px", marginBottom: 4 }}
              >
                7 dias
              </div>
          ...
          <Reveal delay={0.08}>
            ...
            >
              ...
              <div style={{ fontSize: 13, color: T.muted, lineHeight: 1.6, marginBottom: 22 }}>
                Para jardineiros autônomos e pequenas empresas.
              </div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 2, marginBottom: 4 }}>
                <span style={{ fontSize: 17, fontWeight: 600, color: T.muted }}>R$</span>
                <span
                  style={{ fontSize: 44, fontWeight: 800, letterSpacing: "-2px", lineHeight: 1 }}
                >
                  {yearly ? "38" : "47"}
                </span>
              ...
              <div
                style={{ fontSize: 12, color: T.subtle, marginBottom: 22, transition: "all 0.2s" }}
              >
          ...
          <Reveal delay={0.16}>
            ...
            >
              ...
              <div style={{ fontSize: 13, color: T.muted, lineHeight: 1.6, marginBottom: 22 }}>
                Para empresas que querem controle total do negócio.
              </div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 2, marginBottom: 4 }}>
                <span style={{ fontSize: 17, fontWeight: 600, color: T.muted }}>R$</span>
                <span
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                ...
                <span style={{ fontSize: 13.5, color: T.muted }}>
                  +500 profissionais já começaram
                </span>
              </div>
              ...
              >
                7 dias grátis, sem cartão. Configure em minutos e veja a diferença na sua
                produtividade.
              </p>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 13, color: T.muted, lineHeight: 1.64, maxWidth: 230 }}>
              A plataforma de gestão feita especialmente para profissionais de jardinagem e
