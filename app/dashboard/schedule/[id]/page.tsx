            ...
            <CardContent className="p-5">
              ...
              <div className="flex items-start justify-between gap-3 mb-4 pb-4 border-b border-border/60">
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-[17px] leading-tight">{appointment.title}</p>
                  {typeLabel && (
              ...
              <div className="flex flex-col divide-y divide-border/60">
                <div className="flex items-center gap-3 py-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] font-medium capitalize">{dateStr}</p>
                  </div>
                </div>
                ...
                {location && (
                  <div className="flex items-start gap-3 py-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[13px] font-medium leading-snug">{location}</p>
                    </div>
                  </div>
                )}
              </div>
